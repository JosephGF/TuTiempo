...
(function () {
  ...
  Dialog.prototype = {
    ...
    attachEventHandlers: function () {
      // Attach the event handlers
      var okButton = this._dialog.querySelector('.dialog-ok-button'); if (okButton != null) { okButton.addEventListener('touchend', (this._settings.callbackOk).bind(this), false); } var cancelButtion = this._dialog.querySelector('.dialog-cancel-button'); if (cancelButtion != null) { cancelButtion.addEventListener('touchend', (this._settings.callbackCancel).bind(this), false); }
    },
